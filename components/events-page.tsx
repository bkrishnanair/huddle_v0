...
export default function EventsPage() {
  ...
  }, [allNearbyEvents, searchQuery, selectedSport, selectedDate, selectedTime, showOnlyAvailable]);
      ...
      {/* ... (Modals remain the same) ... */}
       {showCreateModal && (
        <CreateEventModal
          ...
          userLocation={null} // This needs to be updated to pass the user's location
        />
      )}
