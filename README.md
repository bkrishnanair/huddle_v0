...
*   **Mobile-First Map Interface**: A thumb-friendly navigation experience featuring a permanent floating search bar, split pill-based filter rows, an ergonomic bottom-right action cluster, and a slide-up "Next Up" event list to maximize map visibility.
